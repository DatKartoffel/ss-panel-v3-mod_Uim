									...
									<div class="tab-content">
										...
										<div class="tab-pane fade active in" id="sub_center">
											...
											<div class="tab-pane fade" id="sub_center_windows">
												<p><span class="icon icon-lg text-white">filter_1</span> <a class="btn-dl" href="{if $config["subscribe_client"]===true}{if $config["subscribe_client_url"]==''}/user/getPcClient{else}{$config["subscribe_client_url"]}/getClient/{$getClient}{/if}?type=ssr-win{else}https://raw.githubusercontent.com/aipeach/ssr-download/master/ShadowsocksR-win.zip{/if}"><i class="material-icons">save_alt</i> 下载</a> SSR(R) - [ SS/SSR ]：</p>
												...
												<hr/>
												<p><span class="icon icon-lg text-white">filter_2</span> <a class="btn-dl" href="{if $config["subscribe_client"]===true}{if $config["subscribe_client_url"]==''}/user/getPcClient{else}{$config["subscribe_client_url"]}/getClient/{$getClient}{/if}?type=v2rayn-win{else}https://github.com/2dust/v2rayN/releases{/if}"><i class="material-icons">save_alt</i> 下载</a> V2RayN - [ SS/VMess ]：</p>
												...
												<hr/>
												<p><span class="icon icon-lg text-white">filter_3</span> <a class="btn-dl" href="/ssr-download/Clash-Windows.7z"><i class="material-icons">save_alt</i> 下载</a> Clash for Windows - [ SS/VMess ]：</p>
											...
											<div class="tab-pane fade" id="sub_center_mac">
												...
												<hr/>
												<p><span class="icon icon-lg text-white">filter_2</span> <a class="btn-dl" href="/ssr-download/ClashX.dmg"><i class="material-icons">save_alt</i> 下载</a> ClashX - [ SS/VMess ]：</p>
                                                ...
                                                <hr/>
												<p><span class="icon icon-lg text-white">filter_3</span> <a class="btn-dl" href="/ssr-download/ClashXR.dmg"><i class="material-icons">save_alt</i> 下载</a> ClashXR - [ SS/SSR/VMess ]：</p>
													<p>教程文档：自行摸索</p>
											...
											<div class="tab-pane fade" id="sub_center_android">
												<p><span class="icon icon-lg text-white">filter_1</span> <a class="btn-dl" href="/ssr-download/ssrr-android.apk"><i class="material-icons">save_alt</i> 下载</a> SSR - [ SSR ]：</p>
												...
												<hr/>
												<p><span class="icon icon-lg text-white">filter_2</span> <a class="btn-dl" href="/ssr-download/v2rayNG.apk"><i class="material-icons">save_alt</i> 下载</a> V2rayNG - [ SS/VMess ]：</p>
												...
												<hr/>
												<p><span class="icon icon-lg text-white">filter_3</span> <a class="btn-dl" href="/ssr-download/Kitsunebi.apk"><i class="material-icons">save_alt</i> 下载</a> Kitsunebi - [ SS/VMess ]：</p>
